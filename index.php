<?php
/*
Plugin Name:Kur Hesabı
Descrition:kur hesabı için
Version:0.1
Author:Ömer Şahin
*/
...
function eklentim(){
    add_menu_page("eklenti başlığım","Eklenti adım","manage_options","eklenti-linkim","eklenti_içeriği");

}
function eklenti_içeriği(){
    $kur = simplexml_load_file("https://www.tcmb.gov.tr/kurlar/today.xml");

foreach ($kur -> Currency as $cur) 
{
	if ($cur["ABD DOLARI"] == "USD")
     {
